...
namespace Alp\Common\Sms\Providers;

use Alp\Common\Email\Email;
use Alp\Common\Sms\Providers\Ali\TopClient;
use Alp\Common\Sms\Providers\Ali\AlibabaAliqinFcSmsNumSendRequest;
...
class SmsProvider
{
    ...
    public static function send($to, $code, $template, $signName)
    {
        ...
        // 数据准备
        $appKey = config('sms.provider.ali.appKey');
        $secretKey = config('sms.provider.ali.secretKey');
